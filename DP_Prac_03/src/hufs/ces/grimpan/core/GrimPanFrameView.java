...
public class GrimPanFrameView extends JFrame {
	...
	private void initialize(){
		...
		jmiNew = new JMenuItem(prop.getProperty("menu.label.new"));   // property를 통해 한글 변환
		...
		jmiOpen = new JMenuItem(prop.getProperty("menu.label.open"));   // property를 통해 한글 변환
		...
		jmiSave = new JMenuItem(prop.getProperty("menu.label.save"));   // property를 통해 한글 변환
		...
		jmiSaveAs = new JMenuItem(prop.getProperty("menu.label.save_as"));   // property를 통해 한글 변환
		...
		jmiExit = new JMenuItem(prop.getProperty("menu.label.exit"));   // property를 통해 한글 변환
		...
		jmiRecovery = new JMenuItem(prop.getProperty("menu.label.recover"));   // property를 통해 한글 변환
		...
		shapeMenu = new JMenu(prop.getProperty("menu.label.shape"));   // property를 통해 한글 변환
		panMenuBar.add(shapeMenu);

		rdbtnmntmLine = new JRadioButtonMenuItem(prop.getProperty("menu.label.line"));   // property를 통해 한글 변환
		...
		rdbtnmntmPen = new JRadioButtonMenuItem(prop.getProperty("menu.label.pencil"));   // property를 통해 한글 변환
		...
		rdbtnmntmPoly = new JRadioButtonMenuItem(prop.getProperty("menu.label.polygon"));   // property를 통해 한글 변환
		...
		rdbtnmntmRegular = new JRadioButtonMenuItem(prop.getProperty("menu.label.regular"));   // property를 통해 한글 변환
		...
		rdbtnmntmOval = new JRadioButtonMenuItem(prop.getProperty("menu.label.oval"));   // property를 통해 한글 변환
		...
		editMenu = new JMenu(prop.getProperty("menu.label.edit"));   // property를 통해 한글 변환
		panMenuBar.add(editMenu);

		jmiUndo = new JMenuItem(prop.getProperty("menu.label.undo"));   // property를 통해 한글 변환
		...
		rmiAdd = new JMenuItem(prop.getProperty("menu.label.add"));   // property를 통해 한글 변환
		...
		jmiRemove = new JMenuItem(prop.getProperty("menu.label.delete"));   // property를 통해 한글 변환
		...
		jmiMove = new JMenuItem(prop.getProperty("menu.label.move"));   // property를 통해 한글 변환
		...
		settingMenu = new JMenu(prop.getProperty("menu.label.setting"));   // property를 통해 한글 변환
		panMenuBar.add(settingMenu);

		jmiStroke = new JMenuItem(prop.getProperty("menu.label.line_weight"));   // property를 통해 한글 변환
		...
		jmiStorkeColor = new JMenuItem(prop.getProperty("menu.label.edge_color"));   // property를 통해 한글 변환
		...
		jcmiFill = new JCheckBoxMenuItem(prop.getProperty("menu.label.full"));   // property를 통해 한글 변환
		...
		jmiFillColor = new JMenuItem(prop.getProperty("menu.label.full_color"));   // property를 통해 한글 변환
		...
		helpMenu = new JMenu(prop.getProperty("menu.label.help"));   // property를 통해 한글 변환
		panMenuBar.add(helpMenu);

		jmiAbout = new JMenuItem(prop.getProperty("menu.label.about"));   // property를 통해 한글 변환
		...
		countLbl = new JLabel("Count: 0            ");          // 초기 라벨상태 -> count: 0
