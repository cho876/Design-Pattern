...
/*
 *	 Decorator Pattern을 이용한 그림판 만들기 
	
	1) GrimPanDecorator 사용
	2) Decorate Menu 중 Transparent 구현
	3) DecorateShapeBuilder의 DECO_TRANS 빈 부분 완성
	4) TansparentGrimShape 완성
	5) 한번 TansparentGrimShape로 wrap할 때마다 0~255인 Color Alpha값을 -20씩 조정 
...
public class GrimPanFrameMain extends JFrame {
	...
	JMenuItem rmiAdd;
	JLabel messageLbl;
	static JLabel countLbl;    // 화면 하단에 count창을 보여주기 위한 라벨 추가
